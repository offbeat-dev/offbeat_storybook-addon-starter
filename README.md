# Storybook Addon Storybook Addon Starter
A Storybook addon starter template covering a series of more advanced use cases. The idea of this starter is to help you get up to speed with different scenarios you may find while developing a storybook addon
